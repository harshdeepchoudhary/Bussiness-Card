...
require_once ('includes/database.php');
 ...
 <form action="https://presentmynd.online/businesscard/deletesuccess.php" method="GET"  enctype="multipart/form-data">
  <div class="form-group">
      
    <label for="exampleInputEmail1">Enter Your Whatsapp Number to Delete IDCard Details</label>
