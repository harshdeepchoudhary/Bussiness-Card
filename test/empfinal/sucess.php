...
?>
          ...
          <div class="page-wrapper" id="home-section">
            ...
            <div class="upper">
              ...
              <center>
                <div class="form-group text-center">
                  ...
                  ?>
                    ...
                    <img style="width:150px; height:150px;background-size:cover; " src="./image/<?php echo $data['photo']; ?>" width="100px">
              ...
              <div class="contact-buttons">
                ...
                <a class="contact-button" target="_blank" href="https://api.whatsapp.com/send/?phone=+91<?php echo $result_row['whatsapp'] ?>&text=Welcom+Mynd+It+Solution%0A&type=phone_number&app_absent=0">
          ...
          <div class="lower">
            ...
            <div style="">
              ...
              <div class="shadow-buttons">
                <a class="shadow-button" href="idcar.php">
                  <i class="fas fa-download shadow-button-icon"></i>
                  Add to
                  Phone Book</a>
                 <a class="shadow-button" href="index.php" download="IDCard.html"> 
                        <i
        ...
        <div class="section-container" id="about-us-section">
          ...
          <div class="qr">
            ...
            <div class="qr-code-wrapper">
              ...
              <a href="https://api.whatsapp.com/send?phone=917647373856"> <img src="./img/qr.png" class="qr-code-image" crossorigin="anonymous"></a>
            </div>
  ...
  <script src="https://cdn.jsdelivr.net/npm/bootstrap@4.4.1/dist/js/bootstrap.min.js" integrity="sha384-wfSDF2E50Y2D1uUdj0O3uMBJnjuUD4Ih7YwaYd1iqfktj0Uod8GCExl3Og8ifwB6" crossorigin="anonymous"></script>
    ...
    echo "<h3>Please Upload Images First!</h3>";
  }
}
?>
