...
$page_title = "Pending Student";

require_once ('includes/header.php');
require_once ('includes/database.php');

//select statement
$query_str = "SELECT * FROM bussiness WHERE paid='no'";
...
<br>
  ...
  <tbody>
	...
	<td><?php echo $result_row['paid']?></td>
		<td><a class="btn btn-info" href="pendingstatus.php?whatsapp=<?php echo $result_row['whatsapp'] ?>" role="button">Approved</a></td>
